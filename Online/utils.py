...
def get_config():
    ...
    parser.add_argument("--DELTA", type=int, default=800, help="Power weight in the reward function, default: 500")
    parser.add_argument("--penalty", type=int, default=1100, help="Penalty due to risk, default: 300")
